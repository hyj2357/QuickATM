...
<body>
  ...
  <div class="top">
   ...
   <div style="z-index:4;position:fixed;top:3.5%;width:100%;">
      <a href="http://localhost:8080/QuickATM/Login">
   ...
   <div class="content">
      <div style="left: 25%;position: absolute;top:20%;">
          <form action="http://localhost:8080/QuickATM/ModifyPassword" method="post">
	          <div class="inputGroup" style="right:0%;">
                ...
                <input name="password" class="inputTxt"  type="password" placeholder="请输入原密码"/><br/><br/><br/>
	          </div>
			  <div class="inputGroup" style="right:0%;">
	            <label>	  
	               <span class="inputLabel" style="font-size:36px;">
                ...
                <input name="newPassword" class="inputTxt"  type="password" placeholder="请输入新密码"/><br/><br/><br/>
	          </div>
	          <div class="inputGroup" style="right:0%;">
	            <label>	  
	               <span class="inputLabel" style="font-size:36px;">
                ...
                <input name="confirmPassword" class="inputTxt"  type="password" placeholder="请输入确认新密码"/><br/><br/><br/>
	          </div>
			  <div>
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://localhost:8080/QuickATM/pfs_s?p=op_deposit.htm'" onclick="window.location.href='op_modifyPassword.htm'"  onmouseout="cgOpBorderDivMouseOut($(this))" onmousemove="cgOpBorderDivMouseOver($(this))">
	    <span>
	     存款
		</span>
	  </div>
      ...
      <div class="op_border_div"  onclick="window.location.href='http://localhost:8080/QuickATM/pfs_s?p=op_modifyPassword.htm'" style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	     修改密码
		</span>
	  </div>
