...
<body>
  ...
  <div class="top">
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://localhost:8080/QuickATM/pfs_s?p=op_draw.htm'" style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	     取款
		</span>
	  </div>
