  ...
  <div class="top">
   ...
   <div class="content">
      <div style="left: 20%;position: absolute;top:30%;">
          <form action="http://localhost:8080/QuickATM/DepositToAccount" method="post">
	          <div class="inputGroup" style="right:0%;">
                ...
                <input name="amount" class="inputTxt"  type="text" placeholder="请输入存款数额"/><br/><br/><br/>
	          </div>
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://localhost:8080/QuickATM/pfs_s?p=op_deposit.htm'"   style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	    存款
		</span>
	  </div>
