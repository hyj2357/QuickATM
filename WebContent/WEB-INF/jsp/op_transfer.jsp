  ...
  <div class="top">
   ...
   <div class="content">
      <div style="left: 25%;position: absolute;top:20%;">
          <form action="http://localhost:8080/QuickATM/TransferAccount" method="post">
	          <div class="inputGroup" style="right:0%;">
                ...
                <input name="targetAccount" class="inputTxt"  type="text" placeholder="请输入转账卡号"/><br/><br/><br/>
	          </div>
			  <div class="inputGroup" style="right:0%;">
	            <label>	  
	               <span class="inputLabel" style="font-size:36px;">
                ...
                <input name="amount" class="inputTxt"  type="text" placeholder="请输入转账数额"/><br/><br/><br/>
	          </div>
			  <div>
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://localhost:8080/QuickATM/pfs_s?p=op_transfer.htm'"   style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	      转账
		</span>
	  </div>
